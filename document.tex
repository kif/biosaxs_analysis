...
from certain pixels.
The subtracted frame is then integrated using pyFAI and the associated uncertainties propagated according to \cite{pyfai-2020}.
...
To be able to extract components, multivariate analysis is perfromed to provide a hint on how many components 
SVD and NMF factorizations are performed 
