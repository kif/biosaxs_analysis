...
\begin{enumerate}
    ...
    \item Select points belonging to the background by comparing exerimental scattering with the first singular-vector from the SVD; average-out selected curves; %If understand the following correclty, it is simply the first 30 \%? is there are reason this is not dome before SVD and NMF
