...
manages the execution of one \textit{dahu-plugins} (see here-after), provides an unique identifier which gives access to the status and output of the processing.
...
Unfortunately, those singular vectors, beyond the first one, do not look like scattering curves since SVD does not enforce the positivity of those extracted singular vectors during the decomposition. 
