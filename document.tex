...
\begin{abstract}
The second phase of the ESRF upgrade program did not only provide a new storage ring (Extremely Brilliant Source, EBS), it also allowed several beam-lines to be refurbished.
...
The BioSAXS beam-line from the European synchrotron \cite{BM29paper} had an automated pipeline for the data-analysis which was based on \textsc{edna} \cite{edna} and was using the \textsc{atsas} (v2.6, \citeasnoun{ATSAS2} software underneath. 
