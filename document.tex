...
$R_g$ is obtained from the linear regression of $log(I(q)) = log(I_0)-1/3 (R_{G}q)^{2}$ on the proper q-range at small angles, called the Guinier Range.
This approximation comes from the Tailor expansion of the scattering curve at $q=0$.
