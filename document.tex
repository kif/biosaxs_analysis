...
In this mode, the thoughput of the beamline is limited by the pipetting system of the robot and the delay for cleaning the exposure chamber.  
...
Sample-changer pipeline produces a new HDF5 file with the subtracted data in it, such file is visualized in figure \ref{subtracted}
